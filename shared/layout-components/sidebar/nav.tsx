...
export const MenuItems : any= [
   ...
   
    {
        menutitle: "PAGES",
            ...
            { icon: PagesIcon, badgetxt: badge1, title: "Pages", type: "sub", active: false, children: [
                    ...
                    {path: "/components/pages/jobs-landing", badgetxt: badge1, type: "link", active: false, selected: false, title: "Jobs Landing" },
    ...
    { menutitle: "MAPS & ICONS"
            ...
            { title: "Maps", icon: MapsIcon, type: "sub", background: "hor-rightangle", active: false, selected: false, children: [
                    ...
                    { path: "/components/maps/vector-maps", type: "link", active: false, selected: false, title: "Vector Maps" },
